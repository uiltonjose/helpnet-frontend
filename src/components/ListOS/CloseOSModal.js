          ...
          <div className="container">
            ...
            <div className="form-group bold">
              ...
              <textarea
                ...
                placeholder="Acrescentes informações para o Cliente"
              />
              <small id="conteudoHelp" className="form-text text-muted">
                O preenchimento deste campo é opcional, as informações contidas
                nesta campo serão enviadas para o cliente.
              </small>
            </div>
            <div align="right" className="topnav search-container">
